...
namespace XConductor.Domain.W8
{
    /// <summary>
    ...
    public class MediaType
    {
        ...
        public int TryGetUInt32(Guid key, int defaultValue = -1)
        {
            ...
            {
                if (exception.HResult == MediaFoundationErrors.MF_E_ATTRIBUTENOTFOUND)
                {
                    // not a problem, return the default
                }
                else if (exception.HResult == MediaFoundationErrors.MF_E_INVALIDTYPE)
                {
